...
# Description: 
# Makes a continuous parameter grid from a floating-point parameter grid. Also 
# requires a flowdirection and flowaccumulation grid. 
# Use separate tools for integer or percent outputs. 
# ---------------------------------------------------------------------------
...
try: 
  ...
  InExpression = "( tmpfacw + " + ParameterGrid + " ) / ( fac + 1.0 )"
  GPMsg("",InExpression)
