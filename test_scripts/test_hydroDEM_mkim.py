...
outdir = r"C:\Users\tbarnhart\projects\datapreptools\data\mkim\%s\input_data.gdb"%(huc)
huc8cov = "local"
origdem = r"C:\Users\tbarnhart\projects\datapreptools\data\mkim\%s\Layers\dem_raw.tif"%(huc)
dendrite = "NHDFlowline"
snap_grid = r"C:\Users\tbarnhart\projects\datapreptools\data\mkim\%s\Layers\dem_raw.tif"%(huc)
bowl_polys = "nhd_wbg"
bowl_lines = "wb_srcg"
inwall = "inwall_edit"
...
bowldepth = 2000
cellsz = 10
scratchWorkspace = r"C:\Users\tbarnhart\projects\datapreptools\data\mkim\%s\tmp"%(huc)
version = None
