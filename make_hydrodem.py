...
def bathymetricGradient(workspace, snapGrid, hucPoly, hydrographyArea, hydrographyFlowline, hydrographyWaterbody,cellsize):
    ...
    #temporary features
    nhd_flow_shp = os.path.join(arcpy.env.workspace,"nhd_flow.shp")
    nhd_flow_Layer = "nhd_flow_Layer"

    nhd_area_shp = os.path.join(arcpy.env.workspace,"nhd_area.shp")
    nhd_area_Layer = "nhd_area_Layer"

    nhd_wb_shp = os.path.join(arcpy.env.workspace,"nhd_wb.shp")
    ...
    arcpy.FeatureClassToFeatureClass_conversion(hydrographyArea, arcpy.env.workspace, "nhd_area.shp")
    ...
    arcpy.FeatureClassToFeatureClass_conversion(hydrographyWaterbody, arcpy.env.workspace, "nhd_wb.shp")
    ...
    arcpy.FeatureClassToFeatureClass_conversion(hydrographyFlowline, arcpy.env.workspace, "nhd_flow.shp")
